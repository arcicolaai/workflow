...
export default {
  ...
  bestSellingItems: {
    ...
    items: [
      { name: "Signature Matcha Latte", price: "₱185", description: "A refreshing iced matcha latte with vibrant green matcha layered over creamy milk and ice for a smooth, earthy, and lightly sweet flavor.", image: "/images/7.png" },
      { name: "Ube Spanish Latte", price: "₱170", description: "A stunning iced Ube Spanish latte a creamy, layered Filipino-inspired drink featuring vibrant purple ube (sweet purple yam with nutty vanilla notes).", image: "/images/20.png" },
      { name: "Dirty Matcha Latte", price: "₱160", description: "A refreshing iced dirty matcha latte a striking layered drink featuring vibrant green matcha blended with creamy milk at the bottom, topped with a bold espresso pour that creates mesmerizing swirls of caramel-brown over ice.", image: "/images/9.png" },
      { name: "Caramel Macchiato", price: "₱129", description: "Iced caramel macchiato layered with milk, espresso, caramel drizzle, and topped with whipped cream.", image: "/images/2.png" }
    ],
  ...
  announcements: {
    title: "Announcements",
    items: [
      { id: "cloud-series", title: "Signature CLOUD SERIES", image: "/images/m1.jpg", description: "Try our new Cloud Series drinks—fluffy, dreamy, and perfect for any moment." },
      { id: "brain-booster", title: "Brain Booster", image: "/images/m2.jpg", description: "Fuel your focus with our Brain Booster lineup. Stay sharp and productive." },
      { id: "coffee-shop", title: "Coffee Shop Setup", image: "/images/m3.jpg", description: "We've upgraded our coffee setup for a better brew every time." },
      { id: "savory-selections", title: "Savory Selections", image: "/images/m4.jpg", description: "New savory items now on the menu. Hearty and satisfying." },
      { id: "anniversary", title: "2ND ANNIVERSARY CELEBRATION", image: "/images/m5.jpg", description: "Celebrate two years with us! Join the party and enjoy special offers." }
    ]
  },
  faq: {
  ...
  footer: {
    ...
    location: { title: "Location", address: "Workflow Coworking Space, 2/F Infinity Business Center, Bernad Avenue, Aguada, Ozamiz City, 7200 Misamis Occidental, Philippines" },
